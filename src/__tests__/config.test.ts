...
describe('config/config When using config', () => {
  describe("an instance of 'config.Config'", () => {
    it(
  ...
  describe('the default config config', () => {
  ...
  describe('the .file() method', () => {
    ...
    describe('the any() method', () => {
      ...
      describe('with a callback', () => {
        it('should respond with the correct value given an array of keys with one matching', () => {
          const value = config.any(['notthis', 'orthis', 'key']);
          expect(value).eql('getThisValue');
        });
